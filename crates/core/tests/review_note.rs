//! End-to-end smoke of the free-form review note over the simulated backends:
//! a note typed in the self-review fix picker must launch a fix run even when
//! the user checked none of the agent's findings — and, with no note and nothing
//! checked, the picker must still short-circuit straight to the PR.
...
/// and drive it to the self-review fix picker.
